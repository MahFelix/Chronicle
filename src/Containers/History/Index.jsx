  ...
  <main className=''>
    ...
    <img  className='absolute p-[10px] bottom-2 rounded-[12px] w-[400px]  ' src={EthanNova1}/>
     ...
     <div  className="flex items-center justify-center h-screen ">
      <div className="bg-white rounded-lg shadow-lg p-20 transform transition w-[1200px] h-[800px] duration-500 hover:scale-110 max-h-500px overflow-y-auto ">
        <div className=''>
