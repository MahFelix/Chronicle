...
const Cardprops = (props) => {
  ...
  return (
    ...
    <div className=' w-[250px] h-[250px] rounded-[12px] opacity-[0.5] transform hover:-translate-y-1 hover:scale-110 transition duration-500 ease-in-out hover:opacity-[1] relative max-lg:w-[150px] max-lg:h-[150px]' id={props.id}  onClick={() => handleClick()} >
