...
const Cardprops = (props) => {
  ...
  return (
    ...
    <div className=' w-[250px] h-[250px] rounded-[12px] opacity-[0.5] transform hover:-translate-y-1 hover:scale-110 transition duration-500 ease-in-out hover:opacity-[1] relative max-lg:w-[100px] max-lg:h-[100px] max-lg:relative  max-lg:top-[100px] max-lg:opacity-100' id={props.id}  onClick={() => handleClick()} >
